...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20240925045311_Initialize') THEN
...
BEGIN
    ...
    CREATE TABLE import_histories (
        id uuid NOT NULL,
        document_type character varying(50) NOT NULL DEFAULT ('UNSPECIFIED'),
        status character varying(20) NOT NULL DEFAULT ('UNSPECIFIED'),
        document jsonb NOT NULL DEFAULT ('{}'),
        remarks character varying(500) DEFAULT (''),
        ...
        updated_by uuid,
        updated_at timestamp with time zone,
        CONSTRAINT pk_import_histories PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE object_storages (
        ...
        updated_by uuid,
        updated_at timestamp with time zone,
        CONSTRAINT pk_object_storages PRIMARY KEY (id)
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20240925045311_Initialize', '8.0.1');
    END IF;
END $EF$;
COMMIT;
