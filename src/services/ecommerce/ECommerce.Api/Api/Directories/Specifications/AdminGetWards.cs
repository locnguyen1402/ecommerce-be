...
public class AdminGetWardsSpecification : Specification<Ward>
{
    public AdminGetWardsSpecification
    (
        string? keyword,
        Guid districtId,
    ...
    {
        Builder.Include($"{nameof(District)}.{nameof(Province)}");
...
public class AdminGetWardsSpecification<TResult> : Specification<Ward, TResult>
{
    public AdminGetWardsSpecification
    (
    ...
    {
        Builder.Include($"{nameof(District)}.{nameof(Province)}");
        Builder.Where(AdminGetWardsSpecification.BuildCriteria(keyword, districtId));
