...
public class AdminGetDistrictsQueryHandler : IEndpointHandler
{
    ...
    {
        var spec = new AdminGetDistrictsSpecification<AdminDistrictResponse>(
            DistrictProjection.ToAdminDistrictResponse()
            , keyword
            , provinceId
            , pagingQuery
        );
