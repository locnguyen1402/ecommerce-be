...
public class IdentityService : IIdentityService
{
    ...
    public Gender Gender
    {
        get
        {
            return Enum.TryParse(_httpContextAccessor.HttpContext?.User?.FindFirst(SecurityClaimTypes.Gender)?.Value, true, out Gender _gender) ? _gender : Gender.UNSPECIFIED;
        }
    }
